...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv" do
    ...
    it "imports the 1st entry from alternate csv" do
      ...
      check_entry(entry_oneB, "Joe", "555-555-3660", "joe@blocmail.com")
    end

    it "imports the 2nd entry from alternate csv" do
      book.import_from_csv("entries_2.csv")
      entry_twoB = book.entries[1]
      check_entry(entry_twoB, "Sally", "555-555-4646", "sally@blocmail.com")
    end

    it "imports the 3rd entry from alternate csv" do
      book.import_from_csv("entries_2.csv")
      entry_threeB = book.entries[2]
      check_entry(entry_threeB, "Sussie", "555-555-2036", "sussie@blocmail.com")
    end
  end
  ...
  describe "#remove_entry" do
    it "removes an entry from the address book" do
      ...
      name, phone_number, email = 'name!', 'phone number?', 'email?!?!'
